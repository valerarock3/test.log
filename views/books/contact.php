        ...
        <div class="row">
            <div class="col-lg-5">
                ...
                <?php $form = ActiveForm::begin(['id' => 'contact-form']); ?>
                    ...
                    <?= $form->field($model, 'email') ->label('Введите ваш email') ?>

                    <?= $form->field($model, 'subject') ->label('Введите ваш предмет') ?>

                    <?= $form->field($model, 'body')->textarea(['rows' => 6]) ->label('Введите ваше предложение') ?>
